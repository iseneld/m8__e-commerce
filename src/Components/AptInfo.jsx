    ...
    <div className="AptInfo-frame">
      <section className="about-apt">
        ...
        <div className="about-apt-desc">
          ...
          <button className={aptInfoApartment && aptInfoApartment.ownerName != "For sale!" ? "offer-btn" :"sell-btn"}>{aptInfoApartment && aptInfoApartment.ownerName != "For sale!" ? "Make Offer" :"Buy now"}</button>
        </div>
      </section>
    </div>
  )
